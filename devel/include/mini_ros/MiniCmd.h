...
struct MiniCmd_
{
  ...
  _motion_type motion;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _movement_type;
...
struct Printer< ::mini_ros::MiniCmd_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mini_ros::MiniCmd_<ContainerAllocator>& v)
  {
    ...
    s << indent << "movement: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.movement);
    s << indent << "x_velocity: ";
